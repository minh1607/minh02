...
!function (e, t) {
    ...
    function l(n, s, r, l, h) {
        var g, x = e.extend({}, e.fn.cycle.defaults, l || {}, e.metadata ? n.metadata() : e.meta ? n.data() : {}), v = e.isFunction(n.data) ? n.data(x.metaAttr) : null;
        ...
        if (n.data("cycle.opts", x), x.$cont = n, x.stopCount = w.cycleStop, x.elements = r, x.before = x.before ? [x.before] : [], x.after = x.after ? [x.after] : [], !e.support.opacity && x.cleartype && x.after.push(function () {
            ...
            if (x.randomMap.sort(function () {
                ...
                }), g)for (var b = 0; b < r.length; b++)x.startingSlide == x.randomMap[b] && (x.randomIndex = b); else x.randomIndex = 1, x.startingSlide = x.randomMap[1]
        ...
        if (I) {
            for (var O = 0, F = 0, A = 0; A < r.length; A++) {
                var k = e(r[A]), T = k[0], H = k.outerWidth(), R = k.outerHeight();
    ...
    e.expr[":"].paused = function (e) {
        ...
        var r = e(t), l = e(n), a = i.speedIn, f = i.speedOut, u = i.easeIn, d = i.easeOut, h = i.animInDelay, p = i.animOutDelay;
    ...
    e.fn.cycle.transitions.none = function (t, n, i) {
        ...
        i.before.push(function (t, n, i) {
            if (t != n) {
                ...
                !function p() {
                    var e = f ? f - parseInt(l * (f / a), 10) : 0, t = h ? h - parseInt(l * (h / a), 10) : 0, n = s > d ? d + parseInt(l * ((s - d) / a || 1), 10) : s, i = c > u ? u + parseInt(l * ((c - u) / a || 1), 10) : c;
